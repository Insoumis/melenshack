...
<body>
	...
	<div class="formAdmin">
		...
		<a class="btn btn-danger btn-lg" href='index.php?sort=deleted'>Posts supprimés</a><br><br>
				...
				<br><input class="form-control" type="number" max="<?php echo $grade ?>" min="0" placeholder="grade" name="value" />0: Peut seulement voter<br>1: Peut upload<br>2: peut upload en masse<br>5: modérateur<br>10: La caste<br>
				<input type="hidden" name="token" id="token" value="<?php echo $token_A?>">
